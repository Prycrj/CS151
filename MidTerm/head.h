...
//Label   Task                                                                                               Goto
//01      (start)                                                                                             02
//02      Initialize logfile                                                                                  03
//03      Create "rayona.txt"                                                                                 04
//04      Initialize 'subtotal','subtotalwTax','fifteen','eighteen','twenty'                                  05
//05      <if (logfile is open)> {print 'first','second,'and 'third' selections;}                             06
//06      Set base subtotal to $20.00 fixed to two decimal places                                             07
//07      If user selects both additonal charge options ('3'&&'7'), subtotal+=7.00                            08
//08      If user selects an additional charge with something else ('3'||'7'), subtotal+=3.50                 09
//09      print to receipt -> subtotal                                                                        10
//10      print to receipt -> subtotalwTax= subtotal * 0.0887 + subtotal;                                     11
//11      print to receipt -> Gratuities at 15,18,20 percent (subtotal*(0.15)|subtotal*(0.18)|subtotal*(0.20) 12
//12      (exit logfile)                                                                                      13
//13      Display order selections ('first','second','third)' to user                                         14
//14      Display subtotal set to two decimal spaces                                                          15
//15      Display subtotalwTax= subtotal * 0.0887 + subtotal;                                                 16
//16      Display Gratuities at 15,18,20 percent (subtotal*(0.15)|subtotal*(0.18)|subtotal*(0.20)             17
//17      (exit)
//18
void receipt()
{
